...
{
    /// <summary>
    /// Port for injecting Game Boy Advance ROMs into Wii U Virtual Console packages.
    /// </summary>
    public interface IGbaRomInjector
    {
        /// <summary>
        /// Injects a Game Boy Advance ROM into the specified workspace.
        /// </summary>
        /// <remarks>
        /// The implementation must cast <paramref name="injection"/>.Options to <see cref="WiiUInjector.Domain.EmulatorOptions.GbaOptions"/>
