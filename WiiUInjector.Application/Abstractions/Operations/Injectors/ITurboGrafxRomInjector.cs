...
{
    /// <summary>
    /// Port for injecting TurboGrafx-16 ROMs into Wii U Virtual Console packages.
    /// </summary>
    public interface ITurboGrafxRomInjector
    {
        /// <summary>
        /// Injects a TurboGrafx-16 ROM into the specified workspace.
        /// </summary>
        /// <remarks>
        /// The implementation must cast <paramref name="injection"/>.Options to <see cref="WiiUInjector.Domain.EmulatorOptions.TurboGrafxOptions"/>
