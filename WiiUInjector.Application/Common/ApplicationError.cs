...
{
    /// <summary>
    /// Immutable value object representing a single application-layer error.
    /// </summary>
    public sealed class ApplicationError
    {
        /// <summary>
        /// Short stable identifier for this error type (e.g., "ROM_NOT_FOUND").
        /// </summary>
        ...
        /// <summary>
        /// Property path or field identifier where the error occurred; may be null for errors not tied to a specific field.
        /// </summary>
        public string Field { get; }

        /// <summary>
        /// Constructs an ApplicationError with the specified code, message, and optional field.
        /// </summary>
        ...
        {
            if (!(obj is ApplicationError other))
                return false;
