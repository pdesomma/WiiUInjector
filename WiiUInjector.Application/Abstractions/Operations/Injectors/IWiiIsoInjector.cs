...
{
    /// <summary>
    /// Port for injecting Nintendo Wii ISO images into Wii U Virtual Console packages.
    /// </summary>
    public interface IWiiIsoInjector
    {
        /// <summary>
        /// Injects a Wii ISO into the specified workspace.
        /// </summary>
        /// <remarks>
        /// The implementation must cast <paramref name="injection"/>.Options to <see cref="WiiUInjector.Domain.EmulatorOptions.WiiOptions"/>
        /// to access console-specific settings such as region patches, controller layout, and video filters.
        ///
